...
- `012` `Eronred/aso-skills`: review-required - Discovery-only pending source-list, license, security, and docs-steward promotion gates.
...
- `056` `antonbabenko/terraform-skill`: skip_duplicate - Exact duplicate raw entry; covered by first normalized target decision.
- `086` `conorluddy/ios-simulator-skill`: skip_duplicate - Exact duplicate raw entry; covered by first normalized target decision.
- `093` `NVIDIA/skills-`: skip_inaccessible - Source could not be resolved through public Git metadata.
- `134` `ComposioHQ/awesome-codex-skills`: quarantine - Quarantine trigger detected; keep reference-only pending explicit approval.
- `152` `ComposioHQ/awesome-codex-skills`: quarantine - Quarantine trigger detected; keep reference-only pending explicit approval.
- `175` `MohamedAbdallah-14/unslop`: skip_duplicate - Exact duplicate raw entry; covered by first normalized target decision.
- `205` `jihe520/social-push`: quarantine - Quarantine trigger detected; keep reference-only pending explicit approval.
- `280` `klajdikkolaj/upwork-autopilot`: quarantine - Quarantine trigger detected; keep reference-only pending explicit approval.
- `284` `ramziddin/solid-skills`: skip_duplicate - Exact duplicate raw entry; covered by first normalized target decision.
