...
The graph is built by `skills/review/scripts/project-scanner.py` (the `_build_dependency_graph()` function)
...
Cross-references: skills/review/scripts/project-scanner.py, references/triage-protocol.md, references/judge-protocol.md.
