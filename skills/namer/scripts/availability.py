...
Usage:
    uv run python skills/namer/scripts/availability.py check-domain neon flux
    uv run python skills/namer/scripts/availability.py check-dev neon flux
    uv run python skills/namer/scripts/availability.py check-social neon flux
    uv run python skills/namer/scripts/availability.py check-all neon flux
"""
