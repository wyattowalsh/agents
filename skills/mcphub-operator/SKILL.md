...
2. Treat **`harness`** as the smallest high-signal set for context-bloat control: Brave Search, DuckDuckGo Search, DDGS (metasearch/news), Context7, DeepWiki, Fetch, and package metadata. Prefer DDGS snippets; avoid `fetch_full_content` unless the user needs full pages.
