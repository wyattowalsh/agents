#!/usr/bin/env python3
"""Portable validator for skill-lifecycle-manager."""
...
def main() -> int:
    ...
    return _run([sys.executable, str(SKILL_DIR / "scripts" / "lifecycle_report.py"), SKILL_DIR.name, "--format", "json"]) or exit_code
