...
Do not commit generated `.claude`, `.cursor`, `.opencode`, `.agent`, `.crush`, or `.codex` OpenSpec artifacts unless the user explicitly promotes a specific artifact to repo-owned source.
