#!/usr/bin/env python3
"""Portable validator for skill-install-dry-run-planner."""
...
def main() -> int:
    ...
    return _run([sys.executable, str(SKILL_DIR / "scripts" / "plan_dry_run.py"), "--self-test", "--format", "json"]) or exit_code
