...
| Harness | Present | Gaps | Blind Spots |
|---------|---------|------|-------------|
| {h} | {mcp_list} | {gaps} | {notes} |

### D. Plugins & Extensions

| Harness | Native Plugins | Repo Fallbacks | Notes |
|---------|----------------|----------------|-------|
| {h} | {list} | {list} | {notes} |

### E. Harness Projections

| Harness | projection_surfaces | Missing | Blind Spots |
|---------|---------------------|---------|-------------|
| {h} | {surfaces} | {list} | {notes} |

### F. Hooks

| Harness | Declared | Registry Entries | Surfaces | Blind Spot |
|---------|----------|------------------|----------|------------|
| {h} | {yes/no} | {count} | {paths} | {reason or null} |

Hook discovery parity is enforced via `scripts/check_hook_discovery_parity.py` (W0) and hook-scout (W2). Hook scouts are report-only (`candidates: []`).

### G. Custom / Other

(Additional non-skill surfaces or follow-ups.)
