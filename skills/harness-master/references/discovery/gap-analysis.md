...
Generated from `skills/harness-master/data/discovery/discovery-taxonomy.json`. Do not edit the domain table by hand.
...
| i18n/l10n | i18n-localization | low |
...
See `skills/harness-master/data/discovery/discovery-taxonomy.json` for severity weights and scout queries.
