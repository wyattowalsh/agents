...
from _paths import data_dir, harness_master_dir
...
def render_markdown(taxonomy: dict) -> str:
    lines = [
        ...
        "",
        "Generated from `skills/harness-master/data/discovery/discovery-taxonomy.json`.",
        "Do not edit the domain table by hand.",
        "",
        "## Domain Taxonomy",
        "",
...
def main(argv: list[str] | None = None) -> int:
    ...
    output = args.output or harness_master_dir() / "references" / "discovery" / "gap-analysis.md"
