...
**Tier-T eligibility:** ≤3 file reads OR ≤1 file edit ≤80 LOC; no destructive/prod/git-push/secrets; `grok-auth-expiry: ok`; ineligible for multi-node graphs, overlapping writers, or broad work. If first native dispatch fails, stop Tier-T for the current parent work item and continue locally.
