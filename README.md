...
| grok-delegate | Use when delegating Grok task nodes via native CLI (-p, -r, worktrees, leader) from Codex/OpenCode waves and tune loops. NOT for harness sync or wrappers. |
