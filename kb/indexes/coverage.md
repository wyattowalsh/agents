...
| `wiki/topics/hooks-evals-control-plane.md` | concept | `raw/sources/hooks-evals-control-source.md`; `raw/captures/wagents-eval-cli-capture-w02.md` | covered | 2026-06-25 | Eval/hooks CLI metrics; 56/56 eval coverage, 40 hooks listed. |
...
| `wiki/topics/mcphub-control-plane.md` | concept | `raw/sources/mcphub-control-plane-source.md`; `raw/captures/mcp-registry-capture-w03.md` | covered | 2026-06-25 | 33 servers; 11 groups; 6 client projections; ownership. |
