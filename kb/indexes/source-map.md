...
External source notes are pointer summaries used only for upstream context. Repo-local canonical files remain authoritative for this repository's behavior.
