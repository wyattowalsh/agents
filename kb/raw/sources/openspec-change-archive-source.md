...
| original_location | `openspec/config.yaml`; `openspec/specs/`; `openspec/changes/archive/2026-05-01-*`; `wagents/openspec.py`; `tests/test_openspec_cli.py` |
...
| Archive checklist evidence is required before claiming archive readiness for future changes. | `openspec/changes/archive/2026-05-01-agents-c09-release-archive/tasks.md`; `openspec/changes/archive/2026-05-01-agents-c09-release-archive/validation-matrix.md` | archived change material | The completed release/archive lane recorded checklist and validation gates before archive execution. |
