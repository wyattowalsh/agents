...
| `skills/chrome-devtools*/**` | Retained as active operational Chrome DevTools skills; `/design` references their proof patterns for UI work but does not remove them. |
...
| `docs/src/skill-research/chrome-devtools*.md` | Retained as active Chrome DevTools research pages. |
...
| `docs/src/authoring/skills/chrome-devtools*.mdx` | Retained as active Chrome DevTools catalog authoring rows. |
...
| `docs/src/content/docs/skills/catalog/custom/chrome-devtools*.mdx` | Regenerated and retained from active Chrome DevTools authoring/source rows. |
...
| `docs/src/content/docs/skill-research/chrome-devtools*.mdx` | Regenerated and retained from active Chrome DevTools research pages. |
