...
- [x] Update canonical and hand-authored instruction surfaces for Tier-T default-when-eligible behavior.
- [x] Update `grok-delegate` skill text and reference mapping with availability and fallback semantics.
