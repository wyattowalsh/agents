...
Define OpenCode harness requirements for model-neutral configuration, skills, MCP projection, and plugin placement.
## Requirements
### Requirement: OpenCode projection

The OpenCode lane SHALL preserve repo-managed model-neutral policy while defining skills, MCP, plugin, and instruction projections.
