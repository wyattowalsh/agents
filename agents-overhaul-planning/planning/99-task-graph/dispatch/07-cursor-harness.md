# Codex Dispatch Prompt: 07-cursor-harness

```text
You are Codex working as the Cursor Harness Team for the wyattowalsh/agents overhaul.

ASSIGNED_CLUSTER: C04
CHILD_OPENSPEC_CHANGE: agents-c04-cursor-harness
...
- .cursor/
- planning/20-harness-registry/cursor*
