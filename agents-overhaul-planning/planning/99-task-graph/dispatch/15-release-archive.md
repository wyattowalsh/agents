# Codex Dispatch Prompt: 15-release-archive

```text
You are Codex working as the Release Team for the wyattowalsh/agents overhaul.

ASSIGNED_CLUSTER: C09/C19
CHILD_OPENSPEC_CHANGE: agents-c09-release-archive
...
- README.md
- parent OpenSpec tasks unless final consolidation
