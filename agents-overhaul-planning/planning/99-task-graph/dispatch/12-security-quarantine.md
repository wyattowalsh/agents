# Codex Dispatch Prompt: 12-security-quarantine

```text
You are Codex working as the Security Team for the wyattowalsh/agents overhaul.

ASSIGNED_CLUSTER: C15/C17
CHILD_OPENSPEC_CHANGE: agents-c15-security-quarantine
