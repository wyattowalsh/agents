# Codex Dispatch Prompt: 08-opencode-gemini-harness

```text
You are Codex working as the OpenCode/Gemini Team for the wyattowalsh/agents overhaul.

ASSIGNED_CLUSTER: C04
CHILD_OPENSPEC_CHANGE: agents-c04-opencode-gemini-harness
