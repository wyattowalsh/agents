# Codex Dispatch Prompt: 09-experimental-harnesses

```text
You are Codex working as the Experimental Harness Team for the wyattowalsh/agents overhaul.

ASSIGNED_CLUSTER: C04
CHILD_OPENSPEC_CHANGE: agents-c04-experimental-harnesses
...
- planning/20-harness-registry/perplexity.md
