# Codex Dispatch Prompt: 06-copilot-harness

```text
You are Codex working as the Copilot Harness Team for the wyattowalsh/agents overhaul.

ASSIGNED_CLUSTER: C04
CHILD_OPENSPEC_CHANGE: agents-c04-copilot-harness
...
- .github/
- planning/20-harness-registry/github-copilot*
