# Spec Delta: mcp-live-systems-layer

## ADDED Requirements

### Requirement: Governed capability changes

Every stable capability introduced by the agents platform overhaul SHALL have a durable requirement in `openspec/specs/mcp-live-systems-layer/spec.md` or an active delta under `openspec/changes/agents-platform-overhaul/specs/mcp-live-systems-layer/spec.md`.
