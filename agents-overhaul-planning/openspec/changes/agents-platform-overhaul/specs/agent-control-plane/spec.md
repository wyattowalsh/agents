# Spec Delta: agent-control-plane

## ADDED Requirements

### Requirement: Governed capability changes

Every stable capability introduced by the agents platform overhaul SHALL have a durable requirement in `openspec/specs/agent-control-plane/spec.md` or an active delta under `openspec/changes/agents-platform-overhaul/specs/agent-control-plane/spec.md`.
