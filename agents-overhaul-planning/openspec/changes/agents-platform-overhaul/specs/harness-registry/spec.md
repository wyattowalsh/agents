# Spec Delta: harness-registry

## ADDED Requirements

### Requirement: Governed capability changes

Every stable capability introduced by the agents platform overhaul SHALL have a durable requirement in `openspec/specs/harness-registry/spec.md` or an active delta under `openspec/changes/agents-platform-overhaul/specs/harness-registry/spec.md`.
