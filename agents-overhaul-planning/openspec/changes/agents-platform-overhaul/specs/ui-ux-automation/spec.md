# Spec Delta: ui-ux-automation

## ADDED Requirements

### Requirement: Governed capability changes

Every stable capability introduced by the agents platform overhaul SHALL have a durable requirement in `openspec/specs/ui-ux-automation/spec.md` or an active delta under `openspec/changes/agents-platform-overhaul/specs/ui-ux-automation/spec.md`.
