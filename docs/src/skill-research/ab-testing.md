...
Plan, design, implement A/B tests and experimentation programs. Strong hypothesis framework, sample-size tables, ICE prioritization, playbook building, and statistical rigor emphasis. Cross-references cro and analytics.
...
npx skills add coreyhaines31/marketingskills --skill ab-testing -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
