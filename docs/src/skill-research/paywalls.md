...
Design and optimize in-app paywalls, upgrade prompts, feature gates, and monetization flows.
...
npx skills add coreyhaines31/marketingskills --skill paywalls -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
