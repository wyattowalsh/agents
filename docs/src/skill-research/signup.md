...
Optimize signup, registration, trial start, and early activation flows. Closely related to onboarding and cro.
...
npx skills add coreyhaines31/marketingskills --skill signup -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
