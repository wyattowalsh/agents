...
Structured data / schema markup for SEO and rich results. Distinct from seo-audit; used for both traditional and AI search surfaces.
...
npx skills add coreyhaines31/marketingskills --skill schema -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
