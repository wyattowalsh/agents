...
Reduce churn, build save flows, recover failed payments, win-back campaigns, and community/referral levers for retention.
...
npx skills add coreyhaines31/marketingskills --skill churn-prevention -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
