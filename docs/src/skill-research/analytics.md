...
Analytics setup, auditing, event design, and measurement for growth. Complements ab-testing and ads; see also CRO for page-level optimization.
...
npx skills add coreyhaines31/marketingskills --skill analytics -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
