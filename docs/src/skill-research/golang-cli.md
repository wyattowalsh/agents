...
Install: `npx skills add samber/cc-skills-golang --skill golang-cli -y -g -a antigravity, claude-code, codex, crush, cursor, gemini-cli, github-copilot, grok, opencode` status=inspect-then-install; selector=named
