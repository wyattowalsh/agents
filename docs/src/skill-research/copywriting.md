...
Write or improve marketing copy for pages, ads, emails, etc. Strong emphasis on value prop, specificity, and audience fit; often paired with cro.
...
npx skills add coreyhaines31/marketingskills --skill copywriting -y -g -a antigravity claude-code codex crush cursor gemini-cli github-copilot grok opencode
