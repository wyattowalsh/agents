...
target_agents: ["claude-code", "codex", "cursor", "opencode"]
...
provenance_evidence: "Explicit keep-global/avoid note in authoring catalog. Non-standard pip install is intentional for sync_kind external-tool (Microsoft APM CLI, not observability APM)."
---
