...
install_command: "npx skills add apollographql/skills --skill apollo-client --skill rover --skill apollo-connectors -y -g -a claude-code codex crush cursor opencode"
