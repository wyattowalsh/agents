---
name: "harness-master"
description: "Audit harness configs, discover gaps, usage signals, apply approved fixes. Use when tuning Claude, Codex, Copilot, Cursor, Gemini, Grok, OpenCode, Cherry, or LM Studio. NOT agents, MCP, or app telemetry."
license: "MIT"
model: "opus"
source_kind: "custom"
...
{/* GENERATED-AUTHORING: source=skills/harness-master/SKILL.md; edit SKILL.md then re-run authoring sync */}
