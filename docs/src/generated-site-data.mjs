...
const baseSiteData = {
  "additionalIntegrationSurfaces": [
    {
      "description": "MCPHub registry and generated import pack; not a managed agent family.",
      "href": "https://www.cherry-ai.com/",
      "id": "cherry-studio",
      "label": "Cherry Studio",
      "surface_kind": "mcp-only"
    },
    {
      "description": "Managed MCP configuration client; not a managed agent family.",
    ...
    {
      "description": "Remote MCP connector surface; not a managed agent family.",
    ...
    {
      "description": "MCP plus managed instruction and agent presets, with an optional skill mirror.",
  ...
  "counts": {
    "additionalIntegrationSurfaces": 4,
    "bundledAgents": 20,
    "customMcp": 16,
    "customSkills": 67,
    "externalMcp": 69,
  ...
  "supportedAgents": [
    {
      ...
      "id": "claude-code",
      "label": "Claude Code",
      "runtime_agents": "native subagents",
      "runtime_hooks": "generated",
      "runtime_instructions": "native import",
      "runtime_skills": "plugin/Skills CLI",
      "runtime_tools": "MCP"
    },
    {
      ...
      "id": "codex",
      "label": "Codex",
      "runtime_agents": "dynamic delegation",
      "runtime_hooks": "generated",
      "runtime_instructions": "generated",
      "runtime_skills": "plugin/Skills CLI",
      "runtime_tools": "MCPHub"
    },
    {
      ...
      "id": "crush",
      "label": "Crush",
      "runtime_agents": "not primary",
      "runtime_hooks": "limited",
      "runtime_instructions": "AGENTS.md",
      "runtime_skills": "Skills CLI",
      "runtime_tools": "MCP projection"
    },
    {
      ...
      "id": "cursor",
      "label": "Cursor",
      "runtime_agents": ".cursor/agents",
      "runtime_hooks": "native hooks",
      "runtime_instructions": "rules + AGENTS.md",
      "runtime_skills": "Skills CLI",
      "runtime_tools": "MCPHub"
    },
    {
      ...
      "id": "grok",
      "label": "Grok Build",
      "runtime_agents": "delegation",
      "runtime_hooks": "generated",
      "runtime_instructions": "generated config",
      "runtime_skills": "mirrored skills",
      "runtime_tools": "MCPHub"
    },
    {
      ...
      "id": "opencode",
      "label": "OpenCode",
      "runtime_agents": "native agents",
      "runtime_hooks": "generated",
      "runtime_instructions": "native AGENTS.md",
      "runtime_skills": "Skills CLI",
      "runtime_tools": "MCPHub + plugins"
    }
  ],
  "visualAssets": [
    {
