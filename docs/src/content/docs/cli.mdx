...
<CardGrid>
  ...
  <LinkCard title="Bundle Manifest" href="https://github.com/wyattowalsh/agents/blob/main/agent-bundle.json" description="See the current bundle surface; repo-level bundled agents are not published yet." />
