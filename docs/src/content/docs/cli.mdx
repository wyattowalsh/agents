...
```bash
npx skills add <source> --skill <name> -y -g --agent claude-code --agent codex --agent crush --agent cursor --agent opencode
```
...
**Supported agents:** `claude-code`, `codex`, `crush`, `cursor`, `grok`, `opencode`
...
# Target one harness
wagents skills sync --agent codex
