...
- ~34 MCP servers (brave-search, duckduckgo-search, chrome-devtools, context7, fetch, repomix, docling, arxiv, wikipedia, gmail, linkedin, thinking servers, etc.; ffmpeg is registered but disabled in favor of skill/CLI routing)
