...
The July 2026 corpus records 289 source dispositions and 65 CLI, library, MCP, or plugin artifacts in the successor activation ledger. It currently accepts 20 and keeps 45 incomplete. Candidate MCP servers and broad-hook plugins remain unavailable until explicitly enabled after review.
