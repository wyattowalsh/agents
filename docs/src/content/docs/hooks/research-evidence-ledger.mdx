...
<Badge text="PostToolUse" variant="caution" /> <Badge text="audit" variant="tip" /> <Badge text="codex" variant="default" /> <Badge text="claude-code" variant="default" /> <Badge text="cursor" variant="default" />
