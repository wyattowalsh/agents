...
<Badge text="UserPromptSubmit" variant="caution" /> <Badge text="context" variant="tip" /> <Badge text="codex" variant="default" /> <Badge text="claude-code" variant="default" /> <Badge text="cursor" variant="default" />
