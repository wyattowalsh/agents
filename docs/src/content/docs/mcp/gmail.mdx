---
title: "gmail"
description: "Full Gmail access: search, read, send, draft, label, filter, and batch-manage emails. Supports attachment downloads."
page_kind: "mcp"
...
<Badge text="MCP" variant="note" /> <Badge text="Productivity" variant="default" /> <Badge text="Inbox Zero" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/gmail` via the local control plane. 
