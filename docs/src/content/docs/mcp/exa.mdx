---
title: "exa"
description: "Neural search engine that understands meaning, not just keywords. Optimized for finding technical content, papers, and documentation."
page_kind: "mcp"
...
<Badge text="MCP" variant="note" /> <Badge text="Search and Discovery" variant="tip" /> <Badge text="Neural Search" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/exa` via the local control plane. 
