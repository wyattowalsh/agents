...
description: "Read-only MCP server for release and provenance manifests and workflows"
---
...
> Read-only MCP server for release and provenance manifests and workflows

<Aside type="note" title="Source & provenance">
This page is generated from the repository MCP server directory `mcp/release-provenance/` (source file `mcp/release-provenance/server.py`).
</Aside>
...
```python title="mcp/release-provenance/server.py"
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/mcp/release-provenance/server.py)
