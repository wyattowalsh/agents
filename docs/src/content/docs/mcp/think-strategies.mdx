---
title: "think-strategies"
description: "Strategy-selection toolkit that matches reasoning patterns to problem types. Session management for ongoing analysis threads."
page_kind: "mcp"
source_kind: "registry"
asset_id: "think-strategies"
composed: true
...
<Badge text="MCP" variant="note" /> <Badge text="Thinking and Reasoning" variant="note" /> <Badge text="Routing" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/think-strategies` via the local control plane. 
