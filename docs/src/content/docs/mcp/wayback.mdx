---
title: "wayback"
description: "Access archived pages from the Internet Archive Wayback Machine for historical snapshots and link recovery."
page_kind: "mcp"
...
<Badge text="MCP" variant="note" /> <Badge text="Search and Discovery" variant="tip" /> <Badge text="Archive" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/wayback` via the local control plane. 
