...
description: "Multi-stage reasoning cascade that escalates through progressively deeper analysis levels when simpler passes are insufficient."
page_kind: "mcp"
source_kind: "registry"
asset_id: "cascade-thinking"
composed: true
...
<Badge text="MCP" variant="note" /> <Badge text="Thinking and Reasoning" variant="note" /> <Badge text="Deep Dive" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/cascade-thinking` via the local control plane. 
