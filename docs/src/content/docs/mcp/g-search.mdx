---
title: "g-search"
description: "Google Search results via SerpAPI. Familiar ranking and broad coverage across the public web."
page_kind: "mcp"
...
<Badge text="MCP" variant="note" /> <Badge text="Search and Discovery" variant="tip" /> <Badge text="Google" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/g-search` via the local control plane. 
