---
title: "tavily"
description: "Tavily-powered web search, extraction, crawl, and deep-research workflows for current-event and multi-source investigations."
page_kind: "mcp"
...
<Badge text="MCP" variant="note" /> <Badge text="Search and Discovery" variant="tip" /> <Badge text="Research" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/tavily` via the local control plane. 
