---
title: "ci-artifacts"
description: "Read-only MCP server for docs/public/generated-reports CI JSON and artifact registry metadata"
---
...
> Read-only MCP server for docs/public/generated-reports CI JSON and artifact registry metadata

<Aside type="note" title="Source & provenance">
This page is generated from the repository MCP server directory `mcp/ci-artifacts/` (source file `mcp/ci-artifacts/server.py`).
</Aside>
...
```python title="mcp/ci-artifacts/server.py"
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/mcp/ci-artifacts/server.py)
