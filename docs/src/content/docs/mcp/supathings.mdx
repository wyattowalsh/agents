---
title: "supathings"
description: "Local Things 3 task and project management on macOS through SupaThings MCP. Treat as personal data with write-capable tools."
page_kind: "mcp"
...
<Badge text="MCP" variant="note" /> <Badge text="Productivity" variant="default" /> <Badge text="Things 3" variant="default" /> <Badge text="stdio" variant="note" />
...
`http://127.0.0.1:46683/mcp/supathings` via the local control plane. 
