...
| External skills | `docs/src/authoring/skills/*.mdx`, `docs/public/generated-registries/skills-catalog-index.json`, `wagents/external_skills.py` | `uv run wagents docs generate --no-installed`; `uv run wagents skills sync --dry-run` |
...
- Author curated metadata in `docs/src/authoring/skills/<id>.mdx` (see `AGENTS.md` §2.7).
