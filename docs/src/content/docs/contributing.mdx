...
<CardGrid>
  ...
  <LinkCard title="OpenSpec Workflow" href="/skills/openspec-workflow/" description="Use OpenSpec for non-trivial repo workflow, generated surface, validation, or distribution changes." />
</CardGrid>
