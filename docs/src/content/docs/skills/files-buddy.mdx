...
<Badge text="files-buddy" variant="note" /> <Badge text="2019 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="sonnet" variant="tip" /> <Badge text="Custom" variant="tip" />
