...
<CardGrid>
  <LinkCard title="honest-review" href="/skills/honest-review/" description="Confidence-scored code review with evidence validation for session diffs and full codebase audits." />
</CardGrid>
