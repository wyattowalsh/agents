---
title: "nerdbot"
description: "Create, manage, and improve markdown-first LLM knowledge bases with layered raw/wiki patterns, audits, and provenance. Use for git-friendly KBs. NOT for docs sites (docs-steward) or generic notes."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="nerdbot" variant="note" /> <Badge text="2501 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v0.1.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" /> <Badge text="Custom" variant="tip" />

> Create, manage, and improve markdown-first LLM knowledge bases with layered raw/wiki patterns, audits, and provenance. Use for git-friendly KBs. NOT for docs sites (docs-steward) or generic notes.
