...
**Install:**
```bash
npx skills add github:wyattowalsh/agents --skill nerdbot -y -g --agent claude-code --agent codex --agent gemini-cli --agent antigravity --agent github-copilot --agent opencode
```
