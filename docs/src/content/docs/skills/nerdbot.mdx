...
<Badge text="nerdbot" variant="note" /> <Badge text="3986 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v0.1.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" /> <Badge text="Custom" variant="tip" />
