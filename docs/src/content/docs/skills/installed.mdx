...
**Install:** `npx skills add continuous-improvement -g`
...
<Badge text="docs-steward" variant="note" /> <Badge text="1909 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v2.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" />
...
**Install:** `npx skills add docs-steward -g`
**Use:** `/docs-steward` `[sync|sync installed|enhance|maintain|improve|improve design|improve ux|full|auto]`
