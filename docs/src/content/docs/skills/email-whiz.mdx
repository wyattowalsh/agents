...
<Badge text="email-whiz" variant="note" /> <Badge text="2320 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v4.0.1" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" /> <Badge text="Custom" variant="tip" />
