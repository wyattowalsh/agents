...
<Badge text="prompt-engineer" variant="note" /> <Badge text="2415 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" />
