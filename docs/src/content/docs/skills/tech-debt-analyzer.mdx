...
<Badge text="tech-debt-analyzer" variant="note" /> <Badge text="1330 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" /> <Badge text="Custom" variant="tip" />
...
**Install:**
```bash
npx skills add wyattowalsh/agents/skills/tech-debt-analyzer -g
```
