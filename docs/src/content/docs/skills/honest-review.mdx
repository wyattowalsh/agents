---
title: "honest-review"
description: "Research-driven code review at multiple abstraction levels with strengths acknowledgment, creative review lenses, AI code smell detection, and severity calibration by project type. Two modes: (1) Sess"
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="MIT" variant="note" /> <Badge text="v2.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" />
