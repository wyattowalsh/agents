...
<Badge text="honest-review" variant="note" /> <Badge text="1562 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v3.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" />
