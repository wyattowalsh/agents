...
description: "Implements dependency injection in Golang using samber/do."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="golang-samber-do" variant="note" /> <Badge text="755 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.3" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-samber-do -y -g
```

**Use:** `/golang-samber-do`
