...
<Badge text="expo-deployment" variant="note" /> <Badge text="457 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add expo/skills --skill expo-deployment -y -g
```
