...
<Badge text="agents-sdk" variant="note" /> <Badge text="1174 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add cloudflare/skills --skill agents-sdk -y -g
```
