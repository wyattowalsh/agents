...
<Badge text="context-engineering-collection" variant="note" /> <Badge text="871 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add muratcankoylan/Agent-Skills-for-Context-Engineering --skill context-engineering-collection -y -g
```

**Use:** `/context-engineering-collection`
...
| Display Source | `muratcankoylan/Agent-Skills-for-Context-Engineering` |
| Source Kind | `github` |
