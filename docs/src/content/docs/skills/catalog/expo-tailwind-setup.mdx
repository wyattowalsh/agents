...
<Badge text="expo-tailwind-setup" variant="note" /> <Badge text="1344 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add expo/skills --skill expo-tailwind-setup -y -g
```

**Use:** `/expo-tailwind-setup`
