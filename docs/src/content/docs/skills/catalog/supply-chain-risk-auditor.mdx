...
<Badge text="supply-chain-risk-auditor" variant="note" /> <Badge text="847 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add trailofbits/skills --skill supply-chain-risk-auditor -y -g
```
