...
<Badge text="logging-best-practices" variant="note" /> <Badge text="582 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="boristane" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add boristane/agent-skills --skill logging-best-practices -y -g
```
