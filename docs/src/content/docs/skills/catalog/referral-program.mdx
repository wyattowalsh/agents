...
<Badge text="referral-program" variant="note" /> <Badge text="967 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill referral-program -y -g
```
