...
<Badge text="rust-async-patterns" variant="note" /> <Badge text="331 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill rust-async-patterns -y -g
```
