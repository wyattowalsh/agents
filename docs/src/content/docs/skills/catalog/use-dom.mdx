...
<Badge text="use-dom" variant="note" /> <Badge text="1251 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add expo/skills --skill use-dom -y -g
```
