---
title: "best-of-n"
description: "Implement a task N ways in parallel and pick the best. Spawns multiple subagents in isolated worktrees, evaluates all candidates, and applies the winner."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="best-of-n" variant="note" /> <Badge text="464 words" variant="default" /> <Badge text="Installed" variant="caution" />
