---
title: "codeql"
description: "Scans a codebase for security vulnerabilities using CodeQL's interprocedural data flow and taint tracking analysis."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="codeql" variant="note" /> <Badge text="1984 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add trailofbits/skills --skill codeql -y -g
```
