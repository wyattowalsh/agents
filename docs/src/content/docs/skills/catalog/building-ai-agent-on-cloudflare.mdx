...
<Badge text="building-ai-agent-on-cloudflare" variant="note" /> <Badge text="1098 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add cloudflare/skills --skill building-ai-agent-on-cloudflare -y -g
```

**Use:** `/building-ai-agent-on-cloudflare`
