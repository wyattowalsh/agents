...
<CardGrid>
  <LinkCard title="honest-review" href="/skills/catalog/honest-review/" description="Research-driven code review at multiple abstraction levels with strengths acknowledgment, creative review lenses, AI code smell detection, and severity calibration by project type." />
  <LinkCard title="wargame" href="/skills/catalog/wargame/" description="Domain-agnostic strategic decision analysis and wargaming." />
</CardGrid>
