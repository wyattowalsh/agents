---
title: "langchain-rag"
description: "INVOKE THIS SKILL when building ANY retrieval-augmented generation (RAG) system."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="langchain-rag" variant="note" /> <Badge text="1548 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add langchain-ai/langchain-skills --skill langchain-rag -y -g
```
