...
<Badge text="flutter-theming-apps" variant="note" /> <Badge text="856 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-theming-apps -y -g
```

**Use:** `/flutter-theming-apps`
...
## Contents - [Core Theming Concepts](#core-theming-concepts) - [Material 3 Guidelines](#material-3-guidelines) - [Component Theme Normalization](#component-theme-normalization) - [Button Styling](#button-styling) - [Platform Idioms & Adaptive Design](#platform-idioms--adaptive-design) - [Workflows](#workflows) - [Examples](#examples)
