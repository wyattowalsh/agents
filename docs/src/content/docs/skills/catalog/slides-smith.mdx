---
title: "slides-smith"
description: "Use when you need to create, validate, export, migrate, or review Reveal.js decks in this Vite + React repo. NOT for Slidev/Marp, generic PowerPoint design, skills, agents, or MCP servers."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="slides-smith" variant="note" /> <Badge text="1247 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="slides-repo" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Use:** `/slides-smith` `<workflow> [deck/topic/path]`
