...
<Badge text="plannotator-setup-goal" variant="note" /> <Badge text="1355 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add backnotprop/plannotator --skill plannotator-setup-goal -y -g
```
