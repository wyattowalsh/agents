...
<CardGrid>
  <LinkCard title="skill-creator" href="/skills/catalog/skill-creator/" description="Create, improve, and audit AI agent skills with 13 proven structural patterns." />
  <LinkCard title="orchestrator" href="/skills/catalog/orchestrator/" description="Build and deploy parallel execution via subagent waves, agent teams, and multi-wave pipelines." />
  <LinkCard title="add-badges" href="/skills/catalog/add-badges/" description="Scan a codebase to detect languages, frameworks, CI/CD pipelines, package managers, and tools, then generate and insert shields." />
  <LinkCard title="wargame" href="/skills/catalog/wargame/" description="Domain-agnostic strategic decision analysis and wargaming with AI-controlled actors." />
</CardGrid>
