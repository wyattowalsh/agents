...
description: "Optimize Core Web Vitals (LCP, INP, CLS) for better page experience and search ranking."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="core-web-vitals" variant="note" /> <Badge text="1449 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0" variant="success" /> <Badge text="web-quality-skills" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add addyosmani/web-quality-skills --skill core-web-vitals -y -g
```
