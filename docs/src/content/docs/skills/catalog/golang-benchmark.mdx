...
<Badge text="golang-benchmark" variant="note" /> <Badge text="1216 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.3" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-benchmark -y -g
```
