...
<Badge text="langchain-fundamentals" variant="note" /> <Badge text="1417 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add langchain-ai/langchain-skills --skill langchain-fundamentals -y -g
```
