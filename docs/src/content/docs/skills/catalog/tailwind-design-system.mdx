...
<Badge text="tailwind-design-system" variant="note" /> <Badge text="554 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill tailwind-design-system -y -g
```
