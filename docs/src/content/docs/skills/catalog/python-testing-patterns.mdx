...
<Badge text="python-testing-patterns" variant="note" /> <Badge text="787 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill python-testing-patterns -y -g
```
