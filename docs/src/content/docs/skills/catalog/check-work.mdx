---
title: "check-work"
description: "Check your work with a verification subagent. Spawns a verifier that reviews diffs, runs builds and tests, and evaluates correctness."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="check-work" variant="note" /> <Badge text="1924 words" variant="default" /> <Badge text="Installed" variant="caution" />

> Check your work with a verification subagent. Spawns a verifier that reviews diffs, runs builds and tests, and evaluates correctness. Use when asked to "check work", "verify changes", "self-verify", "/check-work", "/check", "/verify", or "/self-verify".
...
description: >
  ...
  "check work", "verify changes", "self-verify", "/check-work", "/check",
