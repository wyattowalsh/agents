...
description: "Configure `MaterialApp.router` using a package like `go_router` for advanced URL-based navigation."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="flutter-setup-declarative-routing" variant="note" /> <Badge text="844 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-setup-declarative-routing -y -g
```
