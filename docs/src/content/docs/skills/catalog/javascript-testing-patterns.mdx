...
<Badge text="javascript-testing-patterns" variant="note" /> <Badge text="1553 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill javascript-testing-patterns -y -g
```
