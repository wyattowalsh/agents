...
description: "Add beautiful shadcn/ui-styled README badges to projects using shieldcn. Use when adding badges, shields, or status indicators to README files, docs, or markdown."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="shieldcn-badges" variant="note" /> <Badge text="879 words" variant="default" /> <Badge text="v1.0.0" variant="success" /> <Badge text="jal-co" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add jal-co/shieldcn --skill shieldcn-badges -y -g
```
