...
<Badge text="sentry-sdk-setup" variant="note" /> <Badge text="792 words" variant="default" /> <Badge text="Apache-2.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add getsentry/sentry-for-ai --skill sentry-sdk-setup -y -g
```
