...
<Badge text="deep-agents-orchestration" variant="note" /> <Badge text="1536 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add langchain-ai/langchain-skills --skill deep-agents-orchestration -y -g
```
