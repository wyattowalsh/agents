...
<Badge text="differential-review" variant="note" /> <Badge text="985 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add trailofbits/skills --skill differential-review -y -g
```
