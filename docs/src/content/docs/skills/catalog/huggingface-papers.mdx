...
<Badge text="huggingface-papers" variant="note" /> <Badge text="1241 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-papers -y -g
```

**Use:** `/huggingface-papers`
