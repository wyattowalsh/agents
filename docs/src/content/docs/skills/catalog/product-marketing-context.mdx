...
<Badge text="product-marketing-context" variant="note" /> <Badge text="1011 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill product-marketing-context -y -g
```

**Use:** `/product-marketing-context`
