...
<Badge text="transformers-js" variant="note" /> <Badge text="2513 words" variant="default" /> <Badge text="Apache-2.0" variant="success" /> <Badge text="v3.8.1" variant="success" /> <Badge text="huggingface" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill transformers-js -y -g
```
