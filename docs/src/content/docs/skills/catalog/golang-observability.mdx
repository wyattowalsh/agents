...
<Badge text="golang-observability" variant="note" /> <Badge text="1571 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.2.1" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-observability -y -g
```
