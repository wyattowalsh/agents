...
<Badge text="flutter-setting-up-on-macos" variant="note" /> <Badge text="460 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-setting-up-on-macos -y -g
```

**Use:** `/flutter-setting-up-on-macos`
...
## Contents - [Prerequisites](#prerequisites) - [Tooling Configuration](#tooling-configuration) - [Workflow: Configuring macOS Tooling](#workflow-configuring-macos-tooling) - [Workflow: Validating the Environment](#workflow-validating-the-environment) - [Troubleshooting](#troubleshooting)
