...
<Badge text="copywriting" variant="note" /> <Badge text="1033 words" variant="default" /> <Badge text="v2.0.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill copywriting -y -g
```
