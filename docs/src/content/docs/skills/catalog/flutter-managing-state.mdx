...
<Badge text="flutter-managing-state" variant="note" /> <Badge text="1031 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-managing-state -y -g
```

**Use:** `/flutter-managing-state`
...
## Contents - [Core Concepts](#core-concepts) - [Architecture and Data Flow](#architecture-and-data-flow) - [Workflow: Selecting a State Management Approach](#workflow-selecting-a-state-management-approach) - [Workflow: Implementing MVVM with Provider](#workflow-implementing-mvvm-with-provider) - [Examples](#examples)
