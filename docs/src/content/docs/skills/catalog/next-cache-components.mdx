...
<Badge text="next-cache-components" variant="note" /> <Badge text="1200 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add vercel-labs/next-skills --skill next-cache-components -y -g
```
