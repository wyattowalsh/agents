...
<Badge text="fixing-accessibility" variant="note" /> <Badge text="700 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ibelick/ui-skills --skill fixing-accessibility -y -g
```
