...
<Badge text="apollo-ios" variant="note" /> <Badge text="948 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="apollographql" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add apollographql/skills --skill apollo-ios -y -g
```
