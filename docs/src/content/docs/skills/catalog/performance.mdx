...
<Badge text="performance" variant="note" /> <Badge text="1034 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0" variant="success" /> <Badge text="web-quality-skills" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add addyosmani/web-quality-skills --skill performance -y -g
```
