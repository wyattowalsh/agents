---
title: "apollo-router-plugin-creator"
description: "Guide for writing Apollo Router native Rust plugins."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="apollo-router-plugin-creator" variant="note" /> <Badge text="1177 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="apollographql" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add apollographql/skills --skill apollo-router-plugin-creator -y -g
```

**Use:** `/apollo-router-plugin-creator`
