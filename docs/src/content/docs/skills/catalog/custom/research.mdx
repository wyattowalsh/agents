...
composed_by: "research-source-support-fix"
...
<SkillPageHeader
  ...
  badges={[{ text: "research", variant: "note" }, { text: "4106 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed research-source-support-fix from `skills/research/SKILL.md`. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
