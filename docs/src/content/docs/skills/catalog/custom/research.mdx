...
<SkillPageHeader
  name="research"
  description="Deep multi-source research with reviewable plans, source-support auditing, and confidence scoring. Use for technical, academic, market, fact-checking investigation. NOT for code review or simple Q&amp;A."
  installCommand={`npx skills add github:wyattowalsh/agents --skill research -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/research &lt;question or topic&gt; [--depth quick|standard|deep|exhaustive] [--format brief|deep|bib|matrix]"
  badges={[{ text: "research", variant: "note" }, { text: "4096 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/research/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
[Download from GitHub](https://raw.githubusercontent.com/wyattowalsh/agents/main/skills/research/SKILL.md)
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/skills/research/SKILL.md)
