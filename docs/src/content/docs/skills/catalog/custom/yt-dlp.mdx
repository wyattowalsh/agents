---
title: "yt-dlp"
description: "Probe, transcript, and download video/audio with yt-dlp CLI on supported hosts. Use when you need metadata, captions, or local media. Transcript-first (probe, transcript, download)."
---
...
<SkillPageHeader
  ...
  usage="/yt-dlp &lt;probe|transcript|download|playlist|cookies|doctor|help&gt; [url or path]"
  badges={[{ text: "yt-dlp", variant: "note" }, { text: "1376 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
This page is generated from the repository file `skills/yt-dlp/SKILL.md` by `wagents docs generate`.
</Aside>
...
[Download from GitHub](https://raw.githubusercontent.com/wyattowalsh/agents/main/skills/yt-dlp/SKILL.md)
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/skills/yt-dlp/SKILL.md)
