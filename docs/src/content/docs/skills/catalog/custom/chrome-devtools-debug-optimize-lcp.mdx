...
<Badge text="chrome-devtools-debug-optimize-lcp" variant="note" /> <Badge text="602 words" variant="default" /> <Badge text="Apache-2.0" variant="success" /> <Badge text="v0.23.0" variant="success" /> <Badge text="Google LLC" variant="caution" /> <Badge text="Repo-owned" variant="tip" />
