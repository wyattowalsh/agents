...
<SkillPageHeader
  ...
  badges={[{ text: "chrome-devtools-debug-optimize-lcp", variant: "note" }, { text: "602 words", variant: "default" }, { text: "Apache-2.0", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-1 from `skills/chrome-devtools-debug-optimize-lcp/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
