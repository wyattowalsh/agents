...
<SkillPageHeader
  ...
  badges={[{ text: "agent-runtime-governance", variant: "note" }, { text: "941 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/agent-runtime-governance/SKILL.md"
---
name: agent-runtime-governance
description: >-
