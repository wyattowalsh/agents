...
<SkillPageHeader
  ...
  badges={[{ text: "devops-engineer", variant: "note" }, { text: "1429 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/devops-engineer/SKILL.md"
---
name: devops-engineer
description: >-
