...
<SkillPageHeader
  ...
  badges={[{ text: "api-designer", variant: "note" }, { text: "1425 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/api-designer/SKILL.md"
---
name: api-designer
description: >-
