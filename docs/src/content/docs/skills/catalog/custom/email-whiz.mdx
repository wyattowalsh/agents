...
<SkillPageHeader
  ...
  badges={[{ text: "email-whiz", variant: "note" }, { text: "3289 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v5.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-2 from `skills/email-whiz/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/email-whiz/SKILL.md"
---
name: email-whiz
description: >-
