...
composed_by: "compose-custom-wave-6"
...
<SkillPageHeader
  name="skill-creator"
  description="Create, improve, and audit AI agent skills. 14 structural patterns, deterministic scoring. Use when building or reviewing skills. NOT for agents, MCP servers, or running skills."
  installCommand={`npx skills add github:wyattowalsh/agents --skill skill-creator -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/skill-creator &lt;mode&gt; [name]"
  badges={[{ text: "skill-creator", variant: "note" }, { text: "2086 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v2.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-6 from `skills/skill-creator/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/skill-creator/SKILL.md"
---
name: skill-creator
description: >-
