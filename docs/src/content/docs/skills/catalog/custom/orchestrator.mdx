...
> Review and orchestrate parallel execution via subagent waves, teams, and pipelines. Use when 2+ independent actions need coordination. NOT for single-action tasks.
...
**Install:**
```bash
npx skills add github:wyattowalsh/agents --skill orchestrator -y -g --agent claude-code --agent codex --agent gemini-cli --agent antigravity --agent github-copilot --agent opencode
```
...
<CardGrid>
  <LinkCard title="honest-review" href="/skills/catalog/custom/honest-review/" description="Research-driven code review at multiple abstraction levels with strengths acknowledgment, creative review lenses, AI code smell detection, and severity calibration by project type." />
  <LinkCard title="wargame" href="/skills/catalog/custom/wargame/" description="Domain-agnostic strategic decision analysis and wargaming." />
</CardGrid>
