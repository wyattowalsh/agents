...
<SkillPageHeader
  ...
  badges={[{ text: "changelog-writer", variant: "note" }, { text: "1044 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/changelog-writer/SKILL.md"
---
name: changelog-writer
description: >-
