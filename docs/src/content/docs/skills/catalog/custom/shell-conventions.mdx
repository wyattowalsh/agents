...
<SkillPageHeader
  ...
  badges={[{ text: "shell-conventions", variant: "note" }, { text: "976 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/shell-conventions/SKILL.md"
---
name: shell-conventions
description: >-
