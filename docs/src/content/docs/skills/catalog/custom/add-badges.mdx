...
<SkillPageHeader
  name="add-badges"
  description="Detect stack and generate shields.io README badges with icons, colors, live endpoints. Use when adding or updating badges. NOT for README writing, docs, or CI/CD setup."
  installCommand={`npx skills add github:wyattowalsh/agents --skill add-badges -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/add-badges [--profile active] [--include status,package] [--exclude social] [--style flat-square] [--layout centered] [--yes] [--replace] [--dry-run] [--readme PATH] [--dark-mode]"
  badges={[{ text: "add-badges", variant: "note" }, { text: "1832 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed phase4-skill-compose from `skills/add-badges/SKILL.md`. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
