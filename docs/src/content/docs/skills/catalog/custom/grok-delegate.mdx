...
<SkillPageHeader
  ...
  usage="/grok-delegate"
  badges={[{ text: "grok-delegate", variant: "note" }, { text: "874 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
This page is generated from the repository file `skills/grok-delegate/SKILL.md` by `wagents docs generate`.
</Aside>
