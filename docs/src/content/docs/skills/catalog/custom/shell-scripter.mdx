...
<SkillPageHeader
  ...
  badges={[{ text: "shell-scripter", variant: "note" }, { text: "1122 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-6 from `skills/shell-scripter/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/shell-scripter/SKILL.md"
---
name: shell-scripter
description: >-
