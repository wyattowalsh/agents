...
<SkillPageHeader
  ...
  badges={[{ text: "skill-quality-dashboard", variant: "note" }, { text: "144 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
