...
<SkillPageHeader
  name="docling-graph"
  description="Use when designing/reviewing Docling Graph knowledge-graph workflows: templates, contracts, CLI/API configs, inspect reports, exports, traces."
  installCommand={`npx skills add github:wyattowalsh/agents --skill docling-graph -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/docling-graph [mode] [source-or-template-or-question] [options]"
  badges={[{ text: "docling-graph", variant: "note" }, { text: "2172 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
