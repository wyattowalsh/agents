...
<SkillPageHeader
  ...
  badges={[{ text: "docling-graph", variant: "note" }, { text: "2172 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-2 from `skills/docling-graph/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/docling-graph/SKILL.md"
---
name: docling-graph
