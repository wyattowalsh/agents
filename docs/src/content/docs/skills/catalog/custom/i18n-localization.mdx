...
<SkillPageHeader
  ...
  description="Plan and review localization changes across app, docs, and web surfaces."
  installCommand={`npx skills add github:wyattowalsh/agents --skill i18n-localization -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/i18n-localization &lt;mode&gt; [surface-or-locales]"
  badges={[{ text: "i18n-localization", variant: "note" }, { text: "1097 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
