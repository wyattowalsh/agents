...
<SkillPageHeader
  ...
  badges={[{ text: "i18n-localization", variant: "note" }, { text: "1097 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-3 from `skills/i18n-localization/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/i18n-localization/SKILL.md"
---
name: i18n-localization
description: >-
