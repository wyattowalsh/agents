...
<SkillPageHeader
  ...
  badges={[{ text: "chrome-devtools", variant: "note" }, { text: "617 words", variant: "default" }, { text: "Apache-2.0", variant: "success" }, { text: "v0.23.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed phase4-skill-compose from `skills/chrome-devtools/SKILL.md`. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
