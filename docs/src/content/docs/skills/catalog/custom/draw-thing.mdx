...
<SkillPageHeader
  ...
  badges={[{ text: "draw-thing", variant: "note" }, { text: "2099 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-2 from `skills/draw-thing/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/draw-thing/SKILL.md"
---
name: draw-thing
description: >-
