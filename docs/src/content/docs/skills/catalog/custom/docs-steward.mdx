...
<SkillPageHeader
  ...
  badges={[{ text: "docs-steward", variant: "note" }, { text: "2719 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-2 from `skills/docs-steward/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/docs-steward/SKILL.md"
---
name: docs-steward
description: >-
