...
<SkillPageHeader
  ...
  badges={[{ text: "schema-evolution-planner", variant: "note" }, { text: "1158 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/schema-evolution-planner/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/schema-evolution-planner/SKILL.md"
---
name: schema-evolution-planner
description: >-
