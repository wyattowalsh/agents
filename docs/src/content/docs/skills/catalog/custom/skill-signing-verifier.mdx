...
<SkillPageHeader
  ...
  badges={[{ text: "skill-signing-verifier", variant: "note" }, { text: "93 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v0.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
