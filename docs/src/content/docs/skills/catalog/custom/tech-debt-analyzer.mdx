...
<SkillPageHeader
  ...
  badges={[{ text: "tech-debt-analyzer", variant: "note" }, { text: "1330 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-6 from `skills/tech-debt-analyzer/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/tech-debt-analyzer/SKILL.md"
---
name: tech-debt-analyzer
description: >-
