...
<SkillPageHeader
  ...
  badges={[{ text: "new-project", variant: "note" }, { text: "1375 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-4 from `skills/new-project/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/new-project/SKILL.md"
---
name: new-project
description: >-
