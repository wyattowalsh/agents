...
research_slug: "reasoning-router"
...
<SkillPageHeader
  ...
  description="Classify problems and route to optimal thinking MCP (11 available). Monitor confidence, re-route on stall. Use for complex reasoning."
  installCommand={`npx skills add github:wyattowalsh/agents --skill reasoning-router -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/reasoning-router [problem or question]"
  badges={[{ text: "reasoning-router", variant: "note" }, { text: "1539 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v0.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/reasoning-router/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/reasoning-router/SKILL.md"
---
name: reasoning-router
description: >-
