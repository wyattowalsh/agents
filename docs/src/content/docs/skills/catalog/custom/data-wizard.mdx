...
<SkillPageHeader
  ...
  badges={[{ text: "data-wizard", variant: "note" }, { text: "1643 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-2 from `skills/data-wizard/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
