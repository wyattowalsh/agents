...
<Badge text="infrastructure-coder" variant="note" /> <Badge text="1273 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" /> <Badge text="Repo-owned" variant="tip" />
...
This page is generated from the repository file `skills/infrastructure-coder/SKILL.md` by `wagents docs generate`.
</Aside>
