...
research_slug: "infrastructure-coder"
...
<SkillPageHeader
  ...
  description="Infrastructure-as-Code: Terraform, Kubernetes, Docker. Generate, review, cost-compare, security-scan. Use for IaC work. NOT for CI/CD (devops-engineer), application code, or actual pricing."
  installCommand={`npx skills add github:wyattowalsh/agents --skill infrastructure-coder -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/infrastructure-coder &lt;mode&gt; &lt;requirements&gt;"
  badges={[{ text: "infrastructure-coder", variant: "note" }, { text: "1273 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
[Download from GitHub](https://raw.githubusercontent.com/wyattowalsh/agents/main/skills/infrastructure-coder/SKILL.md)
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/skills/infrastructure-coder/SKILL.md)
