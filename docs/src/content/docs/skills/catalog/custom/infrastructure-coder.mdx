...
<SkillPageHeader
  ...
  badges={[{ text: "infrastructure-coder", variant: "note" }, { text: "1273 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/infrastructure-coder/SKILL.md"
---
name: infrastructure-coder
description: >-
