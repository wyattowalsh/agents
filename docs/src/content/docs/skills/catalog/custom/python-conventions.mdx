...
composed_by: "compose-rich-hand-wave-1"
...
<CardGrid>
  <LinkCard title="javascript-conventions" href="/skills/catalog/custom/javascript-conventions/" description="JS/TS tooling conventions. Enforce pnpm. Use when working on JS/TS files or package.json. NOT for Python, backend-only, or shell scripts." />
</CardGrid>
