...
<SkillPageHeader
  ...
  badges={[{ text: "things-manager", variant: "note" }, { text: "2278 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/things-manager/SKILL.md"
---
name: things-manager
description: >-
