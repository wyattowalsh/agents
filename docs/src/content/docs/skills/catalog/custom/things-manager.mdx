...
<SkillPageHeader
  name="things-manager"
  description="Use when reviewing/managing Things 3 via SupaThings MCP: tasks, projects, headings, tags, deadlines, triage, capture, cleanup, and GTD. NOT for calendars, Gmail, database edits, MCP setup, or secrets."
  installCommand={`npx skills add github:wyattowalsh/agents --skill things-manager -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/things-manager &lt;workflow&gt; [details]"
  badges={[{ text: "things-manager", variant: "note" }, { text: "2278 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-7 from `skills/things-manager/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
[Download from GitHub](https://raw.githubusercontent.com/wyattowalsh/agents/main/skills/things-manager/SKILL.md)
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/skills/things-manager/SKILL.md)
