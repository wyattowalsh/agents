...
page_kind: "skill"
source_kind: "custom"
asset_id: "chrome-devtools-troubleshooting"
composed: true
...
research_slug: "chrome-devtools-troubleshooting"
...
<Badge text="chrome-devtools-troubleshooting" variant="note" /> <Badge text="614 words" variant="default" /> <Badge text="Apache-2.0" variant="success" /> <Badge text="v0.23.0" variant="success" /> <Badge text="Google LLC" variant="caution" /> <Badge text="Repo-owned" variant="tip" />
...
**Install:**
```bash
npx skills add github:wyattowalsh/agents --skill chrome-devtools-troubleshooting -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode
```
...
Composed compose-custom-wave-2 from `skills/chrome-devtools-troubleshooting/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
