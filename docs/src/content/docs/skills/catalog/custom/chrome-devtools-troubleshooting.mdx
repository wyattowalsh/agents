...
<SkillPageHeader
  ...
  description="Use when auditing Chrome DevTools MCP setup failures: initialization, connection, page listing, navigation, missing tools, or wrong Chrome profile."
  installCommand={`npx skills add github:wyattowalsh/agents --skill chrome-devtools-troubleshooting -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/chrome-devtools-troubleshooting"
  badges={[{ text: "chrome-devtools-troubleshooting", variant: "note" }, { text: "614 words", variant: "default" }, { text: "Apache-2.0", variant: "success" }, { text: "v0.23.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed phase4-skill-compose from `skills/chrome-devtools-troubleshooting/SKILL.md`. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
