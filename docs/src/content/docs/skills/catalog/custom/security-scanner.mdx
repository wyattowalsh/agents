...
description: "Proactive security assessment with SAST, secrets detection, dependency scanning, and compliance checks. Use for pre-deployment audit. NOT for code review (review) or pen testing."
page_kind: "skill"
source_kind: "custom"
asset_id: "security-scanner"
composed: true
...
research_slug: "security-scanner"
...
<SkillPageHeader
  ...
  description="Proactive security assessment with SAST, secrets detection, dependency scanning, and compliance checks. Use for pre-deployment audit. NOT for code review (review) or pen testing."
  installCommand={`npx skills add github:wyattowalsh/agents --skill security-scanner -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/security-scanner &lt;mode&gt; [path]"
  badges={[{ text: "security-scanner", variant: "note" }, { text: "1312 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-6 from `skills/security-scanner/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/security-scanner/SKILL.md"
---
name: security-scanner
description: >-
