...
page_kind: "skill"
source_kind: "custom"
asset_id: "observability-advisor"
composed: true
...
research_slug: "observability-advisor"
...
<SkillPageHeader
  ...
  description="Design and review logs, metrics, traces, SLOs, and alerting for reliable systems. Use for telemetry strategy and coverage gaps. NOT for live incident command or vendor-specific setup."
  installCommand={`npx skills add github:wyattowalsh/agents --skill observability-advisor -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/observability-advisor &lt;mode&gt; [target]"
  badges={[{ text: "observability-advisor", variant: "note" }, { text: "1461 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/observability-advisor/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
