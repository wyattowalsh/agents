...
<SkillPageHeader
  ...
  badges={[{ text: "observability-advisor", variant: "note" }, { text: "1461 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-4 from `skills/observability-advisor/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/observability-advisor/SKILL.md"
---
name: observability-advisor
description: >-
