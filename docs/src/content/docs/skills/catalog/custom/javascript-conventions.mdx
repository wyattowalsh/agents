...
<SkillPageHeader
  ...
  badges={[{ text: "javascript-conventions", variant: "note" }, { text: "1240 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/javascript-conventions/SKILL.md"
---
name: javascript-conventions
description: >-
