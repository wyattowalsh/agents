...
<SkillPageHeader
  ...
  badges={[{ text: "incident-response-engineer", variant: "note" }, { text: "1079 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-3 from `skills/incident-response-engineer/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/incident-response-engineer/SKILL.md"
---
name: incident-response-engineer
description: >-
