...
<SkillPageHeader
  name="wargame"
  description="Strategic decision analysis and wargaming. Auto-classifies complexity for analysis or simulation. Use for decisions under uncertainty. NOT for simple pros/cons or code review."
  installCommand={`npx skills add github:wyattowalsh/agents --skill wargame -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/wargame &lt;scenario description&gt;"
  badges={[{ text: "wargame", variant: "note" }, { text: "4227 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v2.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-1 from `skills/wargame/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/wargame/SKILL.md"
---
name: wargame
description: >-
