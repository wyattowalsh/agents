...
<SkillPageHeader
  name="files-buddy"
  description="Use when safely auditing, organizing, deduplicating, renaming, archiving, offloading, or reclaiming storage on macOS file systems and cloud-drive folders."
  installCommand={`npx skills add github:wyattowalsh/agents --skill files-buddy -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/files-buddy &lt;mode&gt; &lt;path-or-all-local&gt; [options]"
  badges={[{ text: "files-buddy", variant: "note" }, { text: "2001 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
