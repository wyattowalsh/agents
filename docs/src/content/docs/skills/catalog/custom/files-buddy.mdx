...
<SkillPageHeader
  ...
  badges={[{ text: "files-buddy", variant: "note" }, { text: "2001 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/files-buddy/SKILL.md"
---
name: files-buddy
description: >-
