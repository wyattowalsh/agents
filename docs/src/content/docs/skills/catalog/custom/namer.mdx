---
title: "namer"
description: "Name anything: projects, products, companies, packages."
page_kind: "skill"
source_kind: "custom"
asset_id: "namer"
composed: true
...
<SkillPageHeader
  name="namer"
  description="Name anything: projects, products, companies, packages."
  installCommand={`npx skills add github:wyattowalsh/agents --skill namer -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/namer &lt;thing to name&gt; [--context description] [--style playful|serious|technical|abstract] [--thorough]"
  badges={[{ text: "namer", variant: "note" }, { text: "2242 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-4 from `skills/namer/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/namer/SKILL.md"
---
name: namer
description: >-
...
[Download from GitHub](https://raw.githubusercontent.com/wyattowalsh/agents/main/skills/namer/SKILL.md)
...
---
[View source on GitHub](https://github.com/wyattowalsh/agents/blob/main/skills/namer/SKILL.md)
