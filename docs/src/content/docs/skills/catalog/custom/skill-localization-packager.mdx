...
<SkillPageHeader
  ...
  badges={[{ text: "skill-localization-packager", variant: "note" }, { text: "95 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v0.1.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
