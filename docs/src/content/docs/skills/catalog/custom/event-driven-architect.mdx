...
<SkillPageHeader
  ...
  badges={[{ text: "event-driven-architect", variant: "note" }, { text: "1093 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/event-driven-architect/SKILL.md"
---
name: event-driven-architect
description: >-
