...
page_kind: "skill"
source_kind: "custom"
asset_id: "data-pipeline-architect"
composed: true
...
research_slug: "data-pipeline-architect"
...
<Badge text="data-pipeline-architect" variant="note" /> <Badge text="1218 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="Repo-owned" variant="tip" />
...
**Install:**
```bash
npx skills add github:wyattowalsh/agents --skill data-pipeline-architect -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode
```
...
Composed compose-custom-wave-2 from `skills/data-pipeline-architect/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
