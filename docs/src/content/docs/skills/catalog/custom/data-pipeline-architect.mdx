...
<SkillPageHeader
  ...
  badges={[{ text: "data-pipeline-architect", variant: "note" }, { text: "1218 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-1 from `skills/data-pipeline-architect/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/data-pipeline-architect/SKILL.md"
---
name: data-pipeline-architect
description: >-
