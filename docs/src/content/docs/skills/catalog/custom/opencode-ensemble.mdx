...
<Badge text="opencode-ensemble" variant="note" /> <Badge text="1464 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="hueyexe" variant="caution" /> <Badge text="Repo-owned" variant="tip" />
