...
<SkillPageHeader
  ...
  badges={[{ text: "chrome-devtools-memory-leak-debugging", variant: "note" }, { text: "565 words", variant: "default" }, { text: "Apache-2.0", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
