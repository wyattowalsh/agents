...
Composed phase4-skill-compose from `skills/chrome-devtools-memory-leak-debugging/SKILL.md`. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
