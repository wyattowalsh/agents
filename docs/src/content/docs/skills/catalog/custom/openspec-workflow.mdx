...
page_kind: "skill"
source_kind: "custom"
asset_id: "openspec-workflow"
composed: true
docs_density: standard
license: "MIT"
trust_tier: "repo"
metadata.author: "Wyatt Walsh"
metadata.version: "1.0.0"
research_slug: "openspec-workflow"
...
<SkillPageHeader
  ...
  description="Use when planning, applying, validating, or archiving OpenSpec changes in this repo, or when downstream AI tools need OpenSpec JSON status/instructions."
  installCommand={`npx skills add github:wyattowalsh/agents --skill openspec-workflow -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/openspec-workflow"
  badges={[{ text: "openspec-workflow", variant: "note" }, { text: "824 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/openspec-workflow/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
