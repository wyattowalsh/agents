...
<Badge text="openspec-workflow" variant="note" /> <Badge text="824 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="Wyatt Walsh" variant="caution" /> <Badge text="Repo-owned" variant="tip" />
