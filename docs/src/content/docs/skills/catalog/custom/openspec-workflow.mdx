...
<SkillPageHeader
  ...
  badges={[{ text: "openspec-workflow", variant: "note" }, { text: "824 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/openspec-workflow/SKILL.md"
---
name: openspec-workflow
