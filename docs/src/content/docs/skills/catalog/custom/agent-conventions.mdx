...
<SkillPageHeader
  ...
  badges={[{ text: "agent-conventions", variant: "note" }, { text: "545 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
````yaml title="skills/agent-conventions/SKILL.md"
---
name: agent-conventions
description: >-
