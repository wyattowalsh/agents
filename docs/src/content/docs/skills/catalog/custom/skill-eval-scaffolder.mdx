...
<SkillPageHeader
  ...
  badges={[{ text: "skill-eval-scaffolder", variant: "note" }, { text: "202 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
