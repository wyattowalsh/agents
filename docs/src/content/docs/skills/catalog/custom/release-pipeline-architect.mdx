...
<SkillPageHeader
  ...
  badges={[{ text: "release-pipeline-architect", variant: "note" }, { text: "1101 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/release-pipeline-architect/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/release-pipeline-architect/SKILL.md"
---
name: release-pipeline-architect
description: >-
