...
<Badge text="prompt-engineer" variant="note" /> <Badge text="3388 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.2.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" />
...
<CardGrid>
  <LinkCard title="skill-creator" href="/skills/catalog/custom/skill-creator/" description="Create, improve, and audit AI agent skills." />
  <LinkCard title="research" href="/skills/catalog/custom/research/" description="Deep multi-source research with confidence scoring." />
  <LinkCard title="docs-steward" href="/skills/catalog/custom/docs-steward/" description="Maintain generated and hand-maintained docs surfaces." />
</CardGrid>
