...
<SkillPageHeader
  ...
  description="Prompt engineering. Craft, analyze, harden, convert, design tool prompts, and build PromptOps/eval plans. Use for system, agent, tool, RAG prompts. NOT for running prompts or building agents."
  installCommand={`npx skills add github:wyattowalsh/agents --skill prompt-engineer -y -g --agent antigravity --agent claude-code --agent codex --agent crush --agent cursor --agent gemini-cli --agent github-copilot --agent grok --agent opencode`}
  usage="/prompt-engineer &lt;mode&gt; [target]"
  badges={[{ text: "prompt-engineer", variant: "note" }, { text: "3477 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.2.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-1 from `skills/prompt-engineer/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/prompt-engineer/SKILL.md"
---
name: prompt-engineer
description: >-
