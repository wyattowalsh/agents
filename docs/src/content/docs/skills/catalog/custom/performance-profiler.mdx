...
<SkillPageHeader
  ...
  badges={[{ text: "performance-profiler", variant: "note" }, { text: "1561 words", variant: "default" }, { text: "MIT", variant: "success" }, { text: "v1.0.0", variant: "tip" }, { text: "Repo-owned", variant: "tip" }]}
/>
...
Composed compose-custom-wave-5 from `skills/performance-profiler/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/performance-profiler/SKILL.md"
---
name: performance-profiler
description: >-
