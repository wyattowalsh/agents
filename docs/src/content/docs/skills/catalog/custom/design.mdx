...
Composed compose-custom-wave-2 from `skills/design/SKILL.md` with full SKILL disclosure. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel).
</Aside>
...
````yaml title="skills/design/SKILL.md"
---
name: design
description: >-
