...
<Badge text="slo-implementation" variant="note" /> <Badge text="712 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill slo-implementation -y -g
```
