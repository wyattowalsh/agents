...
<Badge text="incident-runbook-templates" variant="note" /> <Badge text="753 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill incident-runbook-templates -y -g
```
