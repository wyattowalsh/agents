...
<Badge text="fixing-motion-performance" variant="note" /> <Badge text="800 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ibelick/ui-skills --skill fixing-motion-performance -y -g
```
