---
title: "golang-continuous-integration"
description: "Provides CI/CD pipeline configuration using GitHub Actions for Golang projects."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="golang-continuous-integration" variant="note" /> <Badge text="1617 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.2.0" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-continuous-integration -y -g
```

**Use:** `/golang-continuous-integration`
