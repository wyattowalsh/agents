---
title: "skill-scanner"
description: "Scan agent skills for security issues. Use when asked to &quot;scan a skill&quot;, &quot;audit a skill&quot;, &quot;review skill security&quot;, &quot;check skill for injection&quot;, &quot;validate SKILL."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="skill-scanner" variant="note" /> <Badge text="1309 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add getsentry/skills --skill skill-scanner -y -g
```
