---
title: "notion-cli"
description: "Use the Notion CLI (`ntn`) to interact with the Notion API, manage workers, and upload files."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="notion-cli" variant="note" /> <Badge text="413 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add makenotion/skills --skill notion-cli -y -g
```
