...
<Badge text="terraform-style-guide" variant="note" /> <Badge text="911 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add hashicorp/agent-skills --skill terraform-style-guide -y -g
```
