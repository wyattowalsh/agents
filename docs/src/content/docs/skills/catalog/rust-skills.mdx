---
title: "rust-skills"
description: "Comprehensive Rust coding guidelines with 179 rules across 14 categories. Use when writing, reviewing, or refactoring Rust code."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="rust-skills" variant="note" /> <Badge text="2047 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="leonardomso" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add leonardomso/rust-skills --skill rust-skills -y -g
```
...
| Display Source | `leonardomso/rust-skills` |
| Source Kind | `github` |
