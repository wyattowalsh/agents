...
<Badge text="langgraph-fundamentals" variant="note" /> <Badge text="2742 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add langchain-ai/langchain-skills --skill langgraph-fundamentals -y -g
```
