---
title: "flutter-handling-http-and-json"
...
<Badge text="flutter-handling-http-and-json" variant="note" /> <Badge text="834 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-handling-http-and-json -y -g
```

**Use:** `/flutter-handling-http-and-json`
