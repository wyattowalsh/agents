...
<Badge text="golang-context" variant="note" /> <Badge text="566 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.1" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-context -y -g
```
