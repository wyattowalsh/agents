...
<Badge text="cloudwatch" variant="note" /> <Badge text="1100 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add itsmostafa/aws-agent-skills --skill cloudwatch -y -g
```
