---
title: "golang-dependency-management"
description: "Provides dependency management strategies for Golang projects including go."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="golang-dependency-management" variant="note" /> <Badge text="956 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.3" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-dependency-management -y -g
```

**Use:** `/golang-dependency-management`
