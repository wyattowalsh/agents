...
<Badge text="security-best-practices" variant="note" /> <Badge text="1378 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add openai/skills --skill security-best-practices -y -g
```
