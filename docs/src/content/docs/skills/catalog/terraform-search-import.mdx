...
description: "Discover existing cloud resources using Terraform Search queries and bulk import them into Terraform management."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="terraform-search-import" variant="note" /> <Badge text="1075 words" variant="default" /> <Badge text="v0.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add hashicorp/agent-skills --skill terraform-search-import -y -g
```
