...
<Badge text="huggingface-trackio" variant="note" /> <Badge text="568 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-trackio -y -g
```

**Use:** `/huggingface-trackio`
