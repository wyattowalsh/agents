...
description: "Add Pydantic Logfire observability to applications."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="logfire-instrumentation" variant="note" /> <Badge text="1108 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add pydantic/skills --skill logfire-instrumentation -y -g
```
