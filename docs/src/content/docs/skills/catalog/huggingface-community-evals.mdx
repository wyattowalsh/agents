...
<Badge text="huggingface-community-evals" variant="note" /> <Badge text="883 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-community-evals -y -g
```

**Use:** `/huggingface-community-evals`
