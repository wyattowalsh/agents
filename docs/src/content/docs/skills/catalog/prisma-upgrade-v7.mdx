...
<Badge text="prisma-upgrade-v7" variant="note" /> <Badge text="995 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v7.6.0" variant="success" /> <Badge text="prisma" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add prisma/skills --skill prisma-upgrade-v7 -y -g
```
