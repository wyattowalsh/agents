...
<Badge text="paid-ads" variant="note" /> <Badge text="1391 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill paid-ads -y -g
```
