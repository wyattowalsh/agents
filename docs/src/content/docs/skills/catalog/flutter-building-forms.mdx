...
<Badge text="flutter-building-forms" variant="note" /> <Badge text="632 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-building-forms -y -g
```

**Use:** `/flutter-building-forms`
...
## Contents - [Form Architecture](#form-architecture) - [Field Validation](#field-validation) - [Workflow: Implementing a Validated Form](#workflow-implementing-a-validated-form) - [Examples](#examples)
