---
title: "mcp-builder"
description: "Build Model Context Protocol (MCP) servers with mcp-use framework."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="mcp-builder" variant="note" /> <Badge text="1771 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add mcp-use/skills --skill mcp-builder -y -g
```
