...
<Badge text="huggingface-gradio" variant="note" /> <Badge text="3643 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-gradio -y -g
```

**Use:** `/huggingface-gradio`
