...
<Badge text="golang-concurrency" variant="note" /> <Badge text="1145 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.4" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-concurrency -y -g
```
