...
<Badge text="excalidraw-diagram-generator" variant="note" /> <Badge text="3013 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill excalidraw-diagram-generator -y -g
```
