...
<Badge text="sales-enablement" variant="note" /> <Badge text="2124 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill sales-enablement -y -g
```
