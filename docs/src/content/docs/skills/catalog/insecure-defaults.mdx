...
<Badge text="insecure-defaults" variant="note" /> <Badge text="631 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add trailofbits/skills --skill insecure-defaults -y -g
```
