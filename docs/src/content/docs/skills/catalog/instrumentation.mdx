...
<Badge text="instrumentation" variant="note" /> <Badge text="1019 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add pydantic/skills --skill instrumentation -y -g
```
