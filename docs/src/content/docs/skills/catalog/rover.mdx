...
<Badge text="rover" variant="note" /> <Badge text="633 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.1" variant="success" /> <Badge text="apollographql" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add apollographql/skills --skill rover -y -g
```
