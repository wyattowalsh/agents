...
<Badge text="flutter-building-layouts" variant="note" /> <Badge text="758 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-building-layouts -y -g
```

**Use:** `/flutter-building-layouts`
...
## Contents - [Core Layout Principles](#core-layout-principles) - [Structural Widgets](#structural-widgets) - [Adaptive and Responsive Design](#adaptive-and-responsive-design) - [Workflow: Implementing a Complex Layout](#workflow-implementing-a-complex-layout) - [Examples](#examples)
