...
<Badge text="expo-api-routes" variant="note" /> <Badge text="1136 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add expo/skills --skill expo-api-routes -y -g
```
