...
<Badge text="phoenix-tracing" variant="note" /> <Badge text="562 words" variant="default" /> <Badge text="Apache-2.0" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="oss@arize.com" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill phoenix-tracing -y -g
```
