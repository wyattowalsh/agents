...
<CardGrid>
  <LinkCard title="javascript-conventions" href="/skills/catalog/javascript-conventions/" description="JS/TS tooling conventions. Enforce pnpm. Use when working on JS/TS files or package.json. NOT for Python, backend-only, or shell scripts." />
</CardGrid>
