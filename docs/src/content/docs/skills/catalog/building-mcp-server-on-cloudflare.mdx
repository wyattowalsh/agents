...
<Badge text="building-mcp-server-on-cloudflare" variant="note" /> <Badge text="758 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add cloudflare/skills --skill building-mcp-server-on-cloudflare -y -g
```

**Use:** `/building-mcp-server-on-cloudflare`
