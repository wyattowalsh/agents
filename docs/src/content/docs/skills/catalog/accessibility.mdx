...
<Badge text="accessibility" variant="note" /> <Badge text="1555 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1" variant="success" /> <Badge text="web-quality-skills" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add addyosmani/web-quality-skills --skill accessibility -y -g
```
