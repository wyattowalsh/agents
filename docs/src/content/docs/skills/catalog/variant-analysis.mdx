...
<Badge text="variant-analysis" variant="note" /> <Badge text="782 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add trailofbits/skills --skill variant-analysis -y -g
```
