---
title: "ctf-pwn"
description: "Provides binary exploitation techniques for CTF challenges."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="ctf-pwn" variant="note" /> <Badge text="2205 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ljagiello/ctf-skills --skill ctf-pwn -y -g
```
