---
title: "firecrawl"
description: "Search, scrape, and interact with the web via the Firecrawl CLI."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="firecrawl" variant="note" /> <Badge text="2037 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add firecrawl/cli --skill firecrawl -y -g
```
