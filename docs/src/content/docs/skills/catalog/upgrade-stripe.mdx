...
<Badge text="upgrade-stripe" variant="note" /> <Badge text="696 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add stripe/ai --skill upgrade-stripe -y -g
```
