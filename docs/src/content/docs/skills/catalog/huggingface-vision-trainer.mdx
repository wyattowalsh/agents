...
<Badge text="huggingface-vision-trainer" variant="note" /> <Badge text="3305 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-vision-trainer -y -g
```

**Use:** `/huggingface-vision-trainer`
