...
<Badge text="design-md" variant="note" /> <Badge text="1047 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add google-labs-code/stitch-skills --skill design-md -y -g
```
