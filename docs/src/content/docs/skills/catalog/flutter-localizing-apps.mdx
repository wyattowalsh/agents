...
<Badge text="flutter-localizing-apps" variant="note" /> <Badge text="674 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-localizing-apps -y -g
```

**Use:** `/flutter-localizing-apps`
...
## Contents - [Core Configuration](#core-configuration) - [Defining ARB Resources](#defining-arb-resources) - [App Integration](#app-integration) - [Advanced Formatting](#advanced-formatting) - [Workflows](#workflows) - [Troubleshooting & Gotchas](#troubleshooting--gotchas)
