...
<CardGrid>
  <LinkCard title="host-panel" href="/skills/catalog/host-panel/" description="Host simulated panel discussions and debates among AI-simulated domain experts." />
  <LinkCard title="prompt-engineer" href="/skills/catalog/prompt-engineer/" description="Comprehensive prompt and context engineering for any AI system." />
