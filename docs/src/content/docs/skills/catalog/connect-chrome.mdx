...
description: "Launch real Chrome controlled by gstack with the Side Panel extension auto-loaded.
...
<Badge text="connect-chrome" variant="note" /> <Badge text="4033 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
Connect Claude to a visible Chrome window with the gstack extension auto-loaded. You see every click, every navigation, every action in real time.
