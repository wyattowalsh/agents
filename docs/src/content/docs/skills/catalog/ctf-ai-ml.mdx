---
title: "ctf-ai-ml"
description: "Provides AI and machine learning techniques for CTF challenges."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="ctf-ai-ml" variant="note" /> <Badge text="692 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ljagiello/ctf-skills --skill ctf-ai-ml -y -g
```
