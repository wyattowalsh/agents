...
<Badge text="neon-postgres-branches" variant="note" /> <Badge text="1614 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add neondatabase/agent-skills --skill neon-postgres-branches -y -g
```
