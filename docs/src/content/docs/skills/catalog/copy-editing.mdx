...
<Badge text="copy-editing" variant="note" /> <Badge text="2070 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill copy-editing -y -g
```
