...
<Badge text="deep-agents-core" variant="note" /> <Badge text="1378 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add langchain-ai/langchain-skills --skill deep-agents-core -y -g
```
