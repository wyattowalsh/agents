...
<Badge text="huggingface-datasets" variant="note" /> <Badge text="452 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-datasets -y -g
```
