...
description: "Patterns and techniques for adding governance, safety, and trust controls to AI agent systems."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="agent-governance" variant="note" /> <Badge text="1809 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill agent-governance -y -g
```
