...
<Badge text="neon-postgres" variant="note" /> <Badge text="2020 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add neondatabase/agent-skills --skill neon-postgres -y -g
```
