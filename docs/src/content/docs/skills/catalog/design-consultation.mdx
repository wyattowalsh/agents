...
generates font+color preview…"
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="design-consultation" variant="note" /> <Badge text="7282 words" variant="default" /> <Badge text="Installed" variant="caution" />
