...
<Badge text="emil-design-eng" variant="note" /> <Badge text="3860 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add emilkowalski/skill --skill emil-design-eng -y -g
```
