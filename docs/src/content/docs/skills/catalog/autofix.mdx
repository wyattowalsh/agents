...
<Badge text="autofix" variant="note" /> <Badge text="977 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coderabbitai/skills --skill autofix -y -g
```
...
| Display Source | `coderabbitai/skills` |
| Source Kind | `github` |
