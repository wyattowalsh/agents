...
<Badge text="golang-project-layout" variant="note" /> <Badge text="720 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.1.3" variant="success" /> <Badge text="samber" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add samber/cc-skills-golang --skill golang-project-layout -y -g
```
