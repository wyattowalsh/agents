...
<Badge text="web-artifacts-builder" variant="note" /> <Badge text="399 words" variant="default" /> <Badge text="Complete terms in LICENSE.txt" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add anthropics/skills --skill web-artifacts-builder -y -g
```
