...
<Badge text="launch-strategy" variant="note" /> <Badge text="1814 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill launch-strategy -y -g
```
