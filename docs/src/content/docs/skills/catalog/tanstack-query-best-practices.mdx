...
<Badge text="tanstack-query-best-practices" variant="note" /> <Badge text="635 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add deckardger/tanstack-agent-skills --skill tanstack-query-best-practices -y -g
```
