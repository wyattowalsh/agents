...
description: "Comprehensive guide for writing and running Terraform tests. Use when creating test files…"
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="terraform-test" variant="note" /> <Badge text="1389 words" variant="default" /> <Badge text="v0.0.2" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add hashicorp/agent-skills --skill terraform-test -y -g
```
