...
<Badge text="ads" variant="note" /> <Badge text="1954 words" variant="default" /> <Badge text="v2.0.1" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill ads -y -g
```
