...
<Badge text="flutter-apply-architecture-best-practices" variant="note" /> <Badge text="763 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-apply-architecture-best-practices -y -g
```
...
## Contents - [Architectural Layers](#architectural-layers) - [Project Structure](#project-structure) - [Workflow: Implementing a New Feature](#workflow-implementing-a-new-feature) - [Examples](#examples)
