---
title: "ctf-osint"
description: "Provides open source intelligence techniques for CTF challenges."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="ctf-osint" variant="note" /> <Badge text="985 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ljagiello/ctf-skills --skill ctf-osint -y -g
```
