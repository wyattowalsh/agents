...
<Badge text="ai-seo" variant="note" /> <Badge text="2557 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill ai-seo -y -g
```
