...
<Badge text="ctf-forensics" variant="note" /> <Badge text="4014 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ljagiello/ctf-skills --skill ctf-forensics -y -g
```
