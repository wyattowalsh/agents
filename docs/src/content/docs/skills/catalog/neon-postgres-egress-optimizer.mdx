...
<Badge text="neon-postgres-egress-optimizer" variant="note" /> <Badge text="1323 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add neondatabase/agent-skills --skill neon-postgres-egress-optimizer -y -g
```
