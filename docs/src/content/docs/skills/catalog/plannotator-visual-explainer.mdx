...
description: "Generate self-contained HTML visualizations with Plannotator theming."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="plannotator-visual-explainer" variant="note" /> <Badge text="728 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add backnotprop/plannotator --skill plannotator-visual-explainer -y -g
```
