...
description: "Reviews and authors Cloudflare Workers code against production best practices. Load when writing new Workers, reviewing Worker code, configuring wrangler."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="workers-best-practices" variant="note" /> <Badge text="927 words" variant="default" /> <Badge text="Installed" variant="caution" />
