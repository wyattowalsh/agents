...
description: "Scaffold and implement authentication in TypeScript/JavaScript apps using Better Auth."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="create-auth-skill" variant="note" /> <Badge text="1639 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add better-auth/skills --skill create-auth-skill -y -g
```

**Use:** `/create-auth-skill`
