...
<Badge text="agent-owasp-compliance" variant="note" /> <Badge text="1491 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill agent-owasp-compliance -y -g
```
