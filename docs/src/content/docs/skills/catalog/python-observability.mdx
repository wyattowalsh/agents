...
<Badge text="python-observability" variant="note" /> <Badge text="722 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill python-observability -y -g
```
