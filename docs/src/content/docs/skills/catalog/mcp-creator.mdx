...
<CardGrid>
  <LinkCard title="skill-creator" href="/skills/catalog/skill-creator/" description="Create, improve, and audit AI agent skills. Applies 13 proven structural patterns, scores quality with deterministic audit, manages full lifecycle." />
</CardGrid>
