...
then fixes the plan to get there. Works in plan mode."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="plan-design-review" variant="note" /> <Badge text="10121 words" variant="default" /> <Badge text="Installed" variant="caution" />
