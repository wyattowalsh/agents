...
description: "Add `flutter_localizations` and `intl` dependencies, enable &quot;generate true&quot; in `pubspec.yaml`, and create an `l10n.yaml` configuration file."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="flutter-setup-localization" variant="note" /> <Badge text="652 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-setup-localization -y -g
```
...
## Contents - [Core Concepts](#core-concepts) - [Setup Workflow](#setup-workflow) - [Implementation Workflow](#implementation-workflow) - [Advanced Formatting](#advanced-formatting) - [Examples](#examples)
