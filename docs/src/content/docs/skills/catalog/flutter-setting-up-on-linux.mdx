...
<Badge text="flutter-setting-up-on-linux" variant="note" /> <Badge text="580 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-setting-up-on-linux -y -g
```

**Use:** `/flutter-setting-up-on-linux`
...
## Contents - [System Dependencies](#system-dependencies) - [Workflow: Configuring the Linux Toolchain](#workflow-configuring-the-linux-toolchain) - [Workflow: Validating the Environment](#workflow-validating-the-environment) - [Workflow: Preparing for Distribution (Snapcraft)](#workflow-preparing-for-distribution-snapcraft) - [Examples](#examples)
