...
<Badge text="flutter-handling-concurrency" variant="note" /> <Badge text="873 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-handling-concurrency -y -g
```

**Use:** `/flutter-handling-concurrency`
