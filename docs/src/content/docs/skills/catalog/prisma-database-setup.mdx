...
<Badge text="prisma-database-setup" variant="note" /> <Badge text="625 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="prisma" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add prisma/skills --skill prisma-database-setup -y -g
```
