...
<Badge text="tanstack-query-best-practices" variant="note" /> <Badge text="23 words" variant="default" /> <Badge text="Curated" variant="note" /> <Badge text="install-now-after-trust-gate" variant="default" />
