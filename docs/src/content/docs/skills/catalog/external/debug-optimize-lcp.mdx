...
research_slug: "debug-optimize-lcp"
...
<SkillPageHeader
  ...
  usage="/debug-optimize-lcp"
  badges={[{ text: "debug-optimize-lcp", variant: "note" }, { text: "173 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Composed compose-external-wave-1 using authoring SSOT (`docs/src/authoring/skills/debug-optimize-lcp.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
