...
<SkillPageHeader
  ...
  badges={[{ text: "plannotator-review", variant: "note" }, { text: "45 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Composed compose-external-wave-8 using authoring SSOT (`docs/src/authoring/skills/plannotator-review.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
...
Entry maintained in authoring SSOT `docs/src/authoring/skills/plannotator-review.mdx` and `docs/public/generated-registries/skills-catalog-index.json`; research context is advisory.
