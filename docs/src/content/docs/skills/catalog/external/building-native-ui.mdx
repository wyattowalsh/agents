...
<SkillPageHeader
  ...
  usage="/building-native-ui"
  badges={[{ text: "building-native-ui", variant: "note" }, { text: "18 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
