...
Composed compose-external-wave-3 using authoring SSOT (`docs/src/authoring/skills/core-web-vitals.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
