...
This page is generated from authoring SSOT `docs/src/authoring/skills/prisma-postgres.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
