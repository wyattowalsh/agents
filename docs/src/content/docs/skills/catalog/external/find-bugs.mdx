...
<Badge text="find-bugs" variant="note" /> <Badge text="23 words" variant="default" /> <Badge text="Inspect first" variant="caution" /> <Badge text="inspect-then-install" variant="default" />
