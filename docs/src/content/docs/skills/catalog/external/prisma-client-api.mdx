...
<SkillPageHeader
  ...
  badges={[{ text: "prisma-client-api", variant: "note" }, { text: "18 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Composed compose-external-wave-9 using authoring SSOT (`docs/src/authoring/skills/prisma-client-api.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run external-skill-auditor before using in production or promoting.
</Aside>
...
````mdx title="docs/src/authoring/skills/prisma-client-api.mdx (full SSOT excerpt)"
---
name: "prisma-client-api"
description: "Curated third-party skill source. Run external-skill-auditor before repo promotion."
title: "Prisma Client Api"
...
{/* GENERATED-AUTHORING: source=config/external-skills.md; entry=prisma-client-api; re-run migration to refresh */}
