...
This page is generated from authoring SSOT `docs/src/authoring/skills/sentry-setup-ai-monitoring.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
