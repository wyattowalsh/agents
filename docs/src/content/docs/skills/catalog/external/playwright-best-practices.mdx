...
<SkillPageHeader
  ...
  badges={[{ text: "playwright-best-practices", variant: "note" }, { text: "18 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
