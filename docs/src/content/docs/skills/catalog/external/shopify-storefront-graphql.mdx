...
This page is generated from authoring SSOT `docs/src/authoring/skills/shopify-storefront-graphql.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
