...
<Badge text="vercel-react-best-practices" variant="note" /> <Badge text="18 words" variant="default" /> <Badge text="Curated" variant="note" /> <Badge text="install-now-after-trust-gate" variant="default" />
...
This page is generated from authoring SSOT `docs/src/authoring/skills/vercel-react-best-practices.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
