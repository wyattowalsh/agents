...
<SkillPageHeader
  ...
  badges={[{ text: "vercel-react-best-practices", variant: "note" }, { text: "10 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Entry maintained in authoring SSOT `docs/src/authoring/skills/vercel-react-best-practices.mdx` and `docs/public/generated-registries/skills-catalog-index.json`; research context is advisory.
