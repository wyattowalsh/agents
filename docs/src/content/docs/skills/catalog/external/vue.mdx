...
Composed compose-external-wave-14 using authoring SSOT (`docs/src/authoring/skills/vue.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
