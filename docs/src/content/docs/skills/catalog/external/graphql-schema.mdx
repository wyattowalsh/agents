...
Composed compose-external-wave-6 using authoring SSOT (`docs/src/authoring/skills/graphql-schema.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
