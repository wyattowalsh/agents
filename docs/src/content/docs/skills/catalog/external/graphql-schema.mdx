...
<SkillPageHeader
  ...
  badges={[{ text: "graphql-schema", variant: "note" }, { text: "18 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Composed compose-external-wave-6 using authoring SSOT (`docs/src/authoring/skills/graphql-schema.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run external-skill-auditor before using in production or promoting.
</Aside>
...
````mdx title="docs/src/authoring/skills/graphql-schema.mdx (full SSOT excerpt)"
---
name: "graphql-schema"
description: "Curated third-party skill source. Run external-skill-auditor before repo promotion."
title: "Graphql Schema"
...
{/* GENERATED-AUTHORING: source=config/external-skills.md; entry=graphql-schema; re-run migration to refresh */}
