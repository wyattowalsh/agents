...
<SkillPageHeader
  ...
  usage="/golang-grpc"
  badges={[{ text: "golang-grpc", variant: "note" }, { text: "30 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
...
Composed compose-external-wave-5 using authoring SSOT (`docs/src/authoring/skills/golang-grpc.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run external-skill-auditor before using in production or promoting.
</Aside>
...
````mdx title="docs/src/authoring/skills/golang-grpc.mdx (full SSOT excerpt)"
---
name: "golang-grpc"
...
{/* GENERATED-AUTHORING: source=config/external-skills.md; entry=golang-grpc; re-run migration to refresh */}
