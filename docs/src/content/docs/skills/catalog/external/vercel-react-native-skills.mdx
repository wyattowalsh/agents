...
<SkillPageHeader
  ...
  usage="/vercel-react-native-skills"
  badges={[{ text: "vercel-react-native-skills", variant: "note" }, { text: "19 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Composed compose-external-wave-12 using authoring SSOT (`docs/src/authoring/skills/vercel-react-native-skills.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
