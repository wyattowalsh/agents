...
This page is generated from authoring SSOT `docs/src/authoring/skills/performance.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
