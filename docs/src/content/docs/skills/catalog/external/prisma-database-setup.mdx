...
asset_id: "prisma-database-setup"
composed: true
...
research_slug: "prisma-database-setup"
...
<SkillPageHeader
  ...
  usage="/prisma-database-setup"
  badges={[{ text: "prisma-database-setup", variant: "note" }, { text: "10 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
...
Composed compose-external-wave-9 using authoring SSOT (`docs/src/authoring/skills/prisma-database-setup.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
...
Entry maintained in authoring SSOT `docs/src/authoring/skills/prisma-database-setup.mdx` and `docs/public/generated-registries/skills-catalog-index.json`; research context is advisory.
