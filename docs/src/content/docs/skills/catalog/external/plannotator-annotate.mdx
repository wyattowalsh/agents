...
<SkillPageHeader
  ...
  badges={[{ text: "plannotator-annotate", variant: "note" }, { text: "54 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
