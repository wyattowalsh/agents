...
<SkillPageHeader
  ...
  usage="/ctf-writeup"
  badges={[{ text: "ctf-writeup", variant: "note" }, { text: "47 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
...
Composed compose-external-wave-3 using authoring SSOT (`docs/src/authoring/skills/ctf-writeup.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
...
Entry maintained in authoring SSOT `docs/src/authoring/skills/ctf-writeup.mdx` and `docs/public/generated-registries/skills-catalog-index.json`; research context is advisory.
