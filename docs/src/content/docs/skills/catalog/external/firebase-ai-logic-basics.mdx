...
<SkillPageHeader
  ...
  usage="/firebase-ai-logic-basics"
...
Composed compose-external-wave-4 using authoring SSOT (`docs/src/authoring/skills/firebase-ai-logic-basics.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
