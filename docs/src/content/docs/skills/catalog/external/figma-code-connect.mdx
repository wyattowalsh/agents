...
<SkillPageHeader
  ...
  usage="/figma-code-connect"
  badges={[{ text: "figma-code-connect", variant: "note" }, { text: "26 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
