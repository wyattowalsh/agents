...
Composed compose-external-wave-9 using authoring SSOT (`docs/src/authoring/skills/plannotator-last.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
