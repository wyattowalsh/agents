...
<SkillPageHeader
  ...
  usage="/accessibility"
  badges={[{ text: "accessibility", variant: "note" }, { text: "18 words", variant: "default" }, { text: "Curated", variant: "note" }, { text: "install-now-after-trust-gate", variant: "default" }]}
/>
...
Composed compose-external-wave-1 using authoring SSOT (`docs/src/authoring/skills/accessibility.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run external-skill-auditor before using in production or promoting.
</Aside>
...
````mdx title="docs/src/authoring/skills/accessibility.mdx (full SSOT excerpt)"
---
name: "accessibility"
description: "Curated third-party skill source. Run external-skill-auditor before repo promotion."
title: "Accessibility"
...
{/* GENERATED-AUTHORING: source=config/external-skills.md; entry=accessibility; re-run migration to refresh */}
