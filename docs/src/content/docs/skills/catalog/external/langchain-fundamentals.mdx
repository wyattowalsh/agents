...
asset_id: "langchain-fundamentals"
composed: true
...
research_slug: "langchain-fundamentals"
...
<SkillPageHeader
  ...
  usage="/langchain-fundamentals"
  badges={[{ text: "langchain-fundamentals", variant: "note" }, { text: "20 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
...
Composed compose-external-wave-6 using authoring SSOT (`docs/src/authoring/skills/langchain-fundamentals.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
...
Entry maintained in authoring SSOT `docs/src/authoring/skills/langchain-fundamentals.mdx` and `docs/public/generated-registries/skills-catalog-index.json`; research context is advisory.
