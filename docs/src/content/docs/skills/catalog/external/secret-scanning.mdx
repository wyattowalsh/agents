...
Composed compose-external-wave-11 using authoring SSOT (`docs/src/authoring/skills/secret-scanning.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
