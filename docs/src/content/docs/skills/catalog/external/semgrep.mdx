...
<SkillPageHeader
  ...
  usage="/semgrep"
  badges={[{ text: "semgrep", variant: "note" }, { text: "10 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
...
Composed compose-external-wave-10 using authoring SSOT (`docs/src/authoring/skills/semgrep.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
...
Entry maintained in authoring SSOT `docs/src/authoring/skills/semgrep.mdx` and `docs/public/generated-registries/skills-catalog-index.json`; research context is advisory.
