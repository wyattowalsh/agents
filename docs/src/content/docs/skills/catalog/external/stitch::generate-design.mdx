...
This page is generated from authoring SSOT `docs/src/authoring/skills/stitch::generate-design.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
