...
<SkillPageHeader
  ...
  badges={[{ text: "expo-cicd-workflows", variant: "note" }, { text: "19 words", variant: "default" }, { text: "Inspect first", variant: "caution" }, { text: "inspect-then-install", variant: "default" }]}
/>
