...
Composed phase4-skill-compose using authoring SSOT (`docs/src/authoring/skills/apm-cli.mdx`) + research. Do not run `wagents docs generate` on this file (HAND-MAINTAINED sentinel). Run `/review source` before using in production or promoting.
</Aside>
...
````mdx title="docs/src/authoring/skills/apm-cli.mdx (full SSOT excerpt)"
---
name: "apm-cli"
description: "Microsoft Agent Package Manager for remote agent packages—install, sync, audit, harness deploy. NOT observability APM. Repo bundle uses wagents/Skills CLI."
title: "APM CLI"
