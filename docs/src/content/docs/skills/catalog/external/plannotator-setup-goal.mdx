...
This page is generated from authoring SSOT `docs/src/authoring/skills/plannotator-setup-goal.mdx` and `docs/public/generated-registries/skills-catalog-index.json` by `wagents docs generate`.
