...
<Badge text="plannotator-setup-goal" variant="note" /> <Badge text="48 words" variant="default" /> <Badge text="Curated" variant="note" /> <Badge text="install-now-after-trust-gate" variant="default" />
