...
<Badge text="free-tool-strategy" variant="note" /> <Badge text="800 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill free-tool-strategy -y -g
```

**Use:** `/free-tool-strategy`
