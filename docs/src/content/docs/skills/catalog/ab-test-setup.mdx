...
<Badge text="ab-test-setup" variant="note" /> <Badge text="1027 words" variant="default" /> <Badge text="v1.1.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill ab-test-setup -y -g
```
