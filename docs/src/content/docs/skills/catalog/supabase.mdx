...
<Badge text="supabase" variant="note" /> <Badge text="1184 words" variant="default" /> <Badge text="v0.1.2" variant="success" /> <Badge text="supabase" variant="caution" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add supabase/agent-skills --skill supabase -y -g
```
