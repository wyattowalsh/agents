...
description: "INVOKE THIS SKILL when adding Arize AX tracing to an application."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="arize-instrumentation" variant="note" /> <Badge text="2186 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill arize-instrumentation -y -g
```
