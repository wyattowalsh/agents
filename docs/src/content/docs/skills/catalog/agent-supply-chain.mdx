...
<Badge text="agent-supply-chain" variant="note" /> <Badge text="1061 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill agent-supply-chain -y -g
```
