...
<Badge text="flutter-testing-apps" variant="note" /> <Badge text="913 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-testing-apps -y -g
```

**Use:** `/flutter-testing-apps`
...
## Contents - [Core Testing Strategies](#core-testing-strategies) - [Architectural Testing Guidelines](#architectural-testing-guidelines) - [Plugin Testing Guidelines](#plugin-testing-guidelines) - [Workflows](#workflows) - [Examples](#examples)
