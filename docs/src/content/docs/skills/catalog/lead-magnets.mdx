...
<Badge text="lead-magnets" variant="note" /> <Badge text="1619 words" variant="default" /> <Badge text="v1.0.0" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add coreyhaines31/marketingskills --skill lead-magnets -y -g
```
