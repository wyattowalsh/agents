---
title: "imagine"
description: "How to use the image_gen and image_edit tool calls in Grok Build: when to build a visual with code instead of generating it, prompt-craft, reference-first handling of real people, factual grounding,…"
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="imagine" variant="note" /> <Badge text="1519 words" variant="default" /> <Badge text="Installed" variant="caution" />
