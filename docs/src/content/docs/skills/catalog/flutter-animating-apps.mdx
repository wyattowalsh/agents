...
<Badge text="flutter-animating-apps" variant="note" /> <Badge text="881 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-animating-apps -y -g
```

**Use:** `/flutter-animating-apps`
