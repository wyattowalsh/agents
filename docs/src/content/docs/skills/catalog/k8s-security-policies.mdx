...
<Badge text="k8s-security-policies" variant="note" /> <Badge text="704 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add wshobson/agents --skill k8s-security-policies -y -g
```
