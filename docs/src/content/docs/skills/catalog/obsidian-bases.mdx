...
<Badge text="obsidian-bases" variant="note" /> <Badge text="1716 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add git@github.com:kepano/obsidian-skills.git --skill obsidian-bases -y -g
```
