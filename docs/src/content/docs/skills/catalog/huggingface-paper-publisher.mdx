...
<Badge text="huggingface-paper-publisher" variant="note" /> <Badge text="2083 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add huggingface/skills --skill huggingface-paper-publisher -y -g
```

**Use:** `/huggingface-paper-publisher`
