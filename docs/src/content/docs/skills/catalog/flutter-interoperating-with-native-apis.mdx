---
title: "flutter-interoperating-with-native-apis"
...
<Badge text="flutter-interoperating-with-native-apis" variant="note" /> <Badge text="1067 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add flutter/skills --skill flutter-interoperating-with-native-apis -y -g
```

**Use:** `/flutter-interoperating-with-native-apis`
