...
<Badge text="secret-scanning" variant="note" /> <Badge text="1291 words" variant="default" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add github/awesome-copilot --skill secret-scanning -y -g
```
