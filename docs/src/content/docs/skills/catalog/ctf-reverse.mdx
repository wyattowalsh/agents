---
title: "ctf-reverse"
description: "Provides reverse engineering techniques for CTF challenges."
---

import { Badge, Tabs, TabItem, Card, CardGrid, LinkCard, Aside, Steps } from '@astrojs/starlight/components';

<Badge text="ctf-reverse" variant="note" /> <Badge text="1522 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="Installed" variant="caution" />
...
**Install:**
```bash
npx skills add ljagiello/ctf-skills --skill ctf-reverse -y -g
```
