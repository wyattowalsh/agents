...
<Badge text="harness-master" variant="note" /> <Badge text="1816 words" variant="default" /> <Badge text="MIT" variant="success" /> <Badge text="v1.0.0" variant="success" /> <Badge text="wyattowalsh" variant="caution" /> <Badge text="opus" variant="tip" /> <Badge text="Custom" variant="tip" />
...
**Use:** `/harness-master` `[project|global|both] [claude-code|codex|cursor|gemini-cli|antigravity|github-copilot|opencode|all ...]`
