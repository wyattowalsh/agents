---
title: "research"
description: "General-purpose deep research with multi-source synthesis and confidence-scored findings. Auto-classifies complexity from quick lookup to exhaustive investigation."
---
...
**Install:**
```bash
npx skills add wyattowalsh/agents/skills/research -g
```
